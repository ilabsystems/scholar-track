...
<section id="news" class="py-20 px-6 lg:px-12 bg-white">
    <div class="max-w-7xl mx-auto">
        <div class="flex items-end justify-between mb-10 flex-wrap gap-4">
            <div>
                <span class="text-blue-900 font-bold text-xs uppercase tracking-widest">Local Updates</span>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-2xl p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <span class="text-blue-900 font-bold text-xs uppercase tracking-wide">{{ $item['barangay'] }}</span>
                </div>
