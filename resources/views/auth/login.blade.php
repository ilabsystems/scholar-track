            ...
            <div class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="border-t border-slate-200 bg-slate-50 p-8 md:border-r md:border-t-0">
                        <div class="mb-6">
                            <h2 class="mb-2 text-2xl font-bold text-blue-900">Why Scholar Track?</h2>
                    ...
                    <div class="bg-white p-8">
                        ...
                        <div class="mb-8 text-center">
                            <a href="{{ route('welcome') }}" class="mb-2 block text-3xl font-bold text-blue-900 hover:text-blue-800">Scholar Track</a>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input id="email" class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 transition focus:border-transparent focus:ring-2 focus:ring-blue-800" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="you@example.com" />
                                @if ($errors->has('email'))
                            ...
                            <div>
                                ...
                                <input id="password" class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 transition focus:border-transparent focus:ring-2 focus:ring-blue-800"
                                    type="password"
                                    name="password"
                            ...
                            <div class="flex items-center justify-between gap-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="text-sm font-medium text-blue-800 hover:text-blue-900" href="{{ route('password.request') }}">
                                        Forgot password?
                                    </a>
                                @endif
                            </div>
                            ...
                            <!-- Submit Button -->
                            <button type="submit" class="w-full rounded-lg bg-blue-800 px-4 py-2 font-semibold text-white transition duration-200 ease-in-out hover:bg-blue-900">
                                Log in
                            </button>
                        </form>
