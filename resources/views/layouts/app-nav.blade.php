<div class="mt-8 flex-grow flex flex-col">
    <nav class="flex-1 px-2 space-y-1">
        ...
        <a href="{{ route('scholarships.index') }}" class="{{ request()->routeIs('scholarships.index') ? 'bg-slate-800 text-white' : 'text-slate-200 hover:bg-slate-800 hover:text-white' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
